            ...
            <ul class="navbar-nav nav">
              <li class="nav-item">
                ...
                <ul class="dropdown_menu">
                  ...
                  <li class="nav-item">
                    <a href="#" class="nav-link">Home Static Image<vue-feather type="chevron-down"></vue-feather></a>
                    <ul class="dropdown_menu">
                      <li class="nav-item">
              ...
              <li class="nav-item">
                ...
                <ul class="dropdown_menu">
                  <li class="nav-item">
                    <a href="#" class="nav-link">Features <vue-feather type="chevron-down"></vue-feather></a>
                    <ul class="dropdown_menu">
                      <li class="nav-item">
                  ...
                  <li class="nav-item">
                    <a href="#" class="nav-link">Services <vue-feather type="chevron-down"></vue-feather></a>
                    <ul class="dropdown_menu">
                      <li class="nav-item">
                  ...
                  <li class="nav-item">
                    <a href="#" class="nav-link">Project <vue-feather type="chevron-down"></vue-feather></a>
                    <ul class="dropdown_menu">
                      <li class="nav-item">
