      ...
      <div class="container">
        <div class="row h-100 justify-content-center align-items-center">
          <div class="col-lg-6 col-md-12 services-content">
            ...
            <div class="row">
              <div class="col-lg-6 col-md-6 col-sm-6">
                <div class="box"><vue-feather type="lock"></vue-feather> Secure & Fast</div>
              </div>

              <div class="col-lg-6 col-md-6 col-sm-6">
                <div class="box"><vue-feather type="watch"></vue-feather> Rich Experience</div>
              </div>

              <div class="col-lg-6 col-md-6 col-sm-6">
                <div class="box"><vue-feather type="users"></vue-feather> Support Stuffs</div>
              </div>

              <div class="col-lg-6 col-md-6 col-sm-6">
                <div class="box"><vue-feather type="trending-up"></vue-feather> Forex Trading</div>
              </div>

              <div class="col-lg-6 col-md-6 col-sm-6">
                <div class="box"><vue-feather type="folder"></vue-feather> File Backups</div>
              </div>

              <div class="col-lg-6 col-md-6 col-sm-6">
                <div class="box"><vue-feather type="monitor"></vue-feather> Remote Desktop</div>
              </div>

              <div class="col-lg-6 col-md-6 col-sm-6">
                <div class="box"><vue-feather type="mail"></vue-feather> Email Servers</div>
              </div>

              <div class="col-lg-6 col-md-6 col-sm-6">
                <div class="box"><vue-feather type="cloud"></vue-feather> Hybrid Cloud</div>
              </div>
            </div>
          </div>
      ...
      <div class="container">
        <div class="row h-100 justify-content-center align-items-center">
          <div class="col-lg-6 col-md-12 services-left-image">
            <img src="../../../assets/img/services-left-image/big-monitor.png" alt="big-monitor" />
            <img src="../../../assets/img/services-left-image/creative.png" alt="creative" />
            <img src="../../../assets/img/services-left-image/developer.png" alt="developer" />
            <img src="../../../assets/img/services-left-image/flower-top.png" alt="flower-top" />
            <img src="../../../assets/img/services-left-image/small-monitor.png" alt="small-monitor" />
            <img src="../../../assets/img/services-left-image/small-top.png" alt="small-top" />
          ...
          <div class="col-lg-6 col-md-12 services-content">
            ...
            <div class="row">
              <div class="col-lg-6 col-md-6 col-sm-6">
                <div class="box"><vue-feather type="layout"></vue-feather> Responsive Design</div>
              </div>

              <div class="col-lg-6 col-md-6 col-sm-6">
                <div class="box"><vue-feather type="code"></vue-feather> React Web Development</div>
              </div>

              <div class="col-lg-6 col-md-6 col-sm-6">
                <div class="box"><vue-feather type="smartphone"></vue-feather> Android Apps Development</div>
              </div>

              <div class="col-lg-6 col-md-6 col-sm-6">
                <div class="box"><vue-feather type="code"></vue-feather> Laravel Web Development</div>
              </div>

              <div class="col-lg-6 col-md-6 col-sm-6">
                <div class="box"><vue-feather type="smartphone"></vue-feather> iOS Apps Development</div>
              </div>

              <div class="col-lg-6 col-md-6 col-sm-6">
                <div class="box"><vue-feather type="pen-tool"></vue-feather> UX/UI Design</div>
              </div>

              <div class="col-lg-6 col-md-6 col-sm-6">
                <div class="box"><vue-feather type="shopping-cart"></vue-feather> E-commerce Development</div>
              </div>

              <div class="col-lg-6 col-md-6 col-sm-6">
                <div class="box"><vue-feather type="check-circle"></vue-feather> Print Ready Design</div>
              </div>
            </div>
          </div>
        </div>
