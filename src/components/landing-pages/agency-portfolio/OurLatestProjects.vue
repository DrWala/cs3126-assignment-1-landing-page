    ...
    <div class="container">
      <div class="row align-items-center">
        ...
        <div class="col-lg-6 col-md-12">
          <div class="shorting-menu">
            <button class="filter" :class="{ active: itemFilterKey == 'all' }" v-on:click="itemFilterKey = 'all'">
              All
            </button>
            <button class="filter" :class="{ active: itemFilterKey == 'design' }" v-on:click="itemFilterKey = 'design'">
              Design
            </button>
            <button
              class="filter"
            ...
            <button :class="{ active: itemFilterKey == 'architecture' }" v-on:click="itemFilterKey = 'architecture'">
              Architecture
            </button>

            <button :class="{ active: itemFilterKey == 'creative' }" v-on:click="itemFilterKey = 'creative'">
              Creative
            </button>
          </div>
        </div>
      ...
      <div class="projects-items">
        <div class="row justify-content-center">
          <div v-for="item in itemFilter" :key="item.id" class="col-lg-4 col-sm-6">
