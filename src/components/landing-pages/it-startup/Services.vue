        ...
        <div class="col-lg-6 col-md-12 services-content">
          ...
          <div class="row">
            <div class="col-lg-6 col-md-6 col-sm-6">
              <div class="box"><vue-feather type="database"></vue-feather> Cloud databases</div>
            </div>

            <div class="col-lg-6 col-md-6 col-sm-6">
              <div class="box"><vue-feather type="globe"></vue-feather> Website hosting</div>
            </div>

            <div class="col-lg-6 col-md-6 col-sm-6">
              <div class="box"><vue-feather type="file"></vue-feather> File storage</div>
            </div>
